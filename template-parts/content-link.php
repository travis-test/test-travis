			...
			<div class="entry-header_right_wrap">
				<?php
					if ( is_single() ) {
						...
						the_title( '<h3 class="entry-title"><a href="' . esc_url( crystal_get_content_url() ) . '" rel="bookmark">', '</a></h3>' );
					}
				?>
				<?php if ( 'post' === get_post_type() ) : ?>
		...
		<figure class="entry-thumbnail">
			<?php
				if ( is_single() ) {
					...
					<a href="<?php esc_url( crystal_the_content_url() ); ?>" title="<?php esc_attr(the_title_attribute()); ?>"> <?php the_post_thumbnail(); ?> </a>
				<?php }
			?>
		</figure>
	<?php } ?>
